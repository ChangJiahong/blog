...
public final class Commons {
    ...
    public static String root_url(){
        String st = site_option("site_url");
        String rootUrl ="";
    ...
    public static String show_categories(String categories) throws UnsupportedEncodingException {
        if (StringUtils.isNotBlank(categories)) {
            ...
            for (String c : arr) {
                sbuf.append("<a href=\""+site_url("/category/" + URLEncoder.encode(c, "UTF-8")) + "\">" + c + "</a>");
            }
    ...
    public static String show_tags(String tags) throws UnsupportedEncodingException {
        if (StringUtils.isNotBlank(tags)) {
            ...
            StringBuffer sbuf = new StringBuffer();
            for (String c : arr) {
                sbuf.append("<a href=\""+site_url("/tag/" + URLEncoder.encode(c, "UTF-8") )+ "\">" + c + "</a>");
            }
            return sbuf.toString();
        }
        return "";
    ...
    public static Map<String, String> social() {
        ...
        map.put("cjh", WebConst.initConfig.get(prefix + "cjh"));
        return map;
    }
